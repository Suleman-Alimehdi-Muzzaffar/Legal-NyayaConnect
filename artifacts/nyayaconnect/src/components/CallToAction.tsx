    ...
    <section className="relative py-24 overflow-hidden bg-[#0a1a2e]">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="glass-card rounded-3xl p-10 md:p-16 lg:p-20 text-center border border-[#D4AF37]/30 shadow-[0_0_50px_rgba(212,175,55,0.1)] relative overflow-hidden">
          ...
          >
            Connect with India's best lawyers today. Professional guidance is just a click away. First 15-minute consultation is entirely free.
          </motion.p>
          ...
          >
            <button className="w-full sm:w-auto bg-[#D4AF37] hover:bg-[#c4a133] text-[#102542] font-sans text-base lg:text-lg font-bold px-8 py-4 rounded-xl transition-all duration-300 shadow-[0_4px_20px_rgba(212,175,55,0.4)] hover:shadow-[0_8px_30px_rgba(212,175,55,0.6)] transform hover:-translate-y-1">
              Find a Lawyer Now
            </button>
            <button className="w-full sm:w-auto bg-transparent border border-white hover:bg-white/10 text-white font-sans text-base lg:text-lg font-semibold px-8 py-4 rounded-xl transition-all duration-300 transform hover:-translate-y-1">
              Learn More
            </button>
          </motion.div>
        </div>
