              ...
              >
                {featured ? (
                    ...
                    <div className="flex items-start justify-between">
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          ...
                          <p className="font-sans text-sm text-[#D4AF37]">{featured.primarySpecialization}</p>
                        </div>
                      </div>
                  ...
                  <div className="flex flex-col items-center gap-4 py-6 text-center">
                    <div className="w-16 h-16 rounded-full bg-gradient-to-tr from-[#D4AF37] to-[#8c7324] flex items-center justify-center">
