...
import { ArrowLeft, CheckCircle2, Calendar, ShieldCheck } from 'lucide-react';
            ...
            <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.2 }}>
              <div className="bg-[#0a1a2e] p-8 rounded-3xl border border-[#D4AF37]/30 shadow-[0_0_30px_rgba(212,175,55,0.1)] sticky top-32">
                ...
                <div className="mb-8 p-4 rounded-xl bg-white/5 border border-[#D4AF37]/20">
                  <p className="text-gray-400 font-sans text-sm mb-2 flex items-center gap-2">
                    <ShieldCheck className="w-4 h-4 text-[#D4AF37]" /> Recommended
                  </p>
                  <Link to="/find-lawyers" className="font-bold text-white hover:text-[#D4AF37] transition-colors">
                    Browse Verified Advocates
                  </Link>
                  <p className="text-gray-400 text-sm">Match with specialists for this service</p>
                </div>
                
                <Link
                  to="/register/client"
                  className="w-full flex items-center justify-center gap-2 bg-[#D4AF37] hover:bg-[#c4a133] text-[#102542] font-sans font-bold py-4 rounded-xl transition-all duration-300 transform hover:-translate-y-1"
                >
