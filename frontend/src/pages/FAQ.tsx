...
const faqsData = {
  ...
  Consultations: [
    { q: "Can I speak with a lawyer before booking?", a: "Many lawyers offer an introductory call so you can understand if they are the right fit for your case before committing to any paid services." },
...
const FAQ = () => {
  ...
  const filteredFaqs = faqsData[activeCategory as keyof typeof faqsData].filter((faq) => {
