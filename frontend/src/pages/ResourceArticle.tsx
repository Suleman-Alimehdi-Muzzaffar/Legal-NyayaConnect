...
import { getResourceArticle } from '../data/resourceArticles';

const ResourceArticle = () => {
  const { slug } = useParams<{ slug: string }>();
  const article = slug ? getResourceArticle(slug) : undefined;
      ...
      <div className="min-h-screen bg-[#102542] text-white selection:bg-[#D4AF37] selection:text-[#102542] flex flex-col">
        ...
        <main className="flex-grow pt-32 pb-24">
          <div className="container mx-auto px-6 md:px-12 text-center">
            <h1 className="font-serif text-4xl text-[#D4AF37] mb-4">Article Not Found</h1>
      ...
      <main className="flex-grow pt-32 pb-24">
        <div className="container mx-auto px-6 md:px-12">
          ...
          <div className="mb-12">
            ...
            <h1 className="font-serif text-4xl md:text-6xl font-bold mb-3 leading-tight">{article.title}</h1>
            <p className="font-sans text-xl text-[#D4AF37] font-medium mb-6">{article.tagline}</p>
            <p className="font-sans text-lg text-gray-300 max-w-3xl">{article.intro}</p>
          </div>
          ...
          <div className="bg-[#D4AF37]/10 border-l-4 border-[#D4AF37] p-6 rounded-r-xl mb-12 flex items-start gap-4">
            ...
            <div>
              ...
              <p className="font-sans text-gray-300">This article is for general education and is <span className="text-white font-semibold">not legal advice</span>. Laws change and vary by state — always consult a qualified advocate for your specific matter.</p>
            </div>
          </div>
          ...
          <div className="flex flex-col lg:flex-row gap-12 relative">
            ...
            <aside className="lg:w-1/4 hidden lg:block">
              <div className="sticky top-32 glass-card p-6 rounded-2xl border border-white/10">
                <h4 className="font-serif font-bold text-lg mb-4 text-[#D4AF37]">In this article</h4>
            ...
            <article className="lg:w-3/4 font-sans text-gray-300 leading-relaxed space-y-12">
              ...
              <section className="pl-6">
                <div className="bg-gradient-to-r from-[#0a1a2e] to-[#102542] border border-[#D4AF37]/30 rounded-3xl p-8 md:p-12 text-center shadow-[0_0_40px_rgba(212,175,55,0.1)]">
                  <h2 className="font-serif text-2xl md:text-4xl font-bold mb-4">Need help with this matter?</h2>
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 justify-center">
                    ...
                    <Link to="/legal-resources" className="inline-flex items-center justify-center bg-transparent border border-[#D4AF37] text-[#D4AF37] hover:bg-[#D4AF37]/10 font-semibold px-8 py-4 rounded-xl transition-all">
