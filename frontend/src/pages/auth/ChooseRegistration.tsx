              ...
              <Link to="/register/client" className="block h-full">
                ...
                >
                  ...
                  <ul className="space-y-4 mb-10 font-sans text-sm text-gray-300">
                    ...
                    <li className="flex items-center gap-3"><span className="text-[#D4AF37]">✓</span> Verified Lawyers</li>
              ...
              <Link to="/register/lawyer" className="block h-full">
                ...
                >
                  ...
                  <ul className="space-y-4 mb-10 font-sans text-sm text-gray-300">
                    ...
                    <li className="flex items-center gap-3"><span className="text-[#D4AF37]">✓</span> Nationwide Client Reach</li>
